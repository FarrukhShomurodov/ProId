        ...
        <transition name="modal">
            <div class="modal-mask">
                <div class="modal-wrapper">
                    ...
                    <div class="modal-container modal-container-create-business">
                        <!-- Header of the modal -->
                        ...
                        <div class="create-business-content">
                            ...
                            <div>
                                ...
                                <input type="number" v-model=oked class="form_input form_input-business" placeholder="Введите ОКЭД бизнеса"
                            ...
                            <div>
                                ...
                                <input type="text" v-model=name_of_banking_akkaunt class="form_input form_input-business"
                                       :class="{'form_input_error': error && name_of_banking_akkaunt.length === 0}"
                                       placeholder="Введите наименование счет" required>
                            </div>
                            <div>
                                <label>МФО *</label>
                                <input type="number" v-model=mfo class="form_input form_input-business" placeholder="Введите МФО"
